// To parse this data:
//
//   import { Convert, PropertySet } from "./file";
//
//   const propertySet = Convert.toPropertySet(json);
//
 ...
 */
export interface PropertySetArtifact {
    /**
...
export interface TaxonomyModelCoreProperty {
     ...
     */
    property_invocations?: PropertyInvocation[];
    /**
 ...
 */
export interface PropertyInvocation {
    /**
...
export class Convert {
    public static toPropertySet(json: string): PropertySet {
        return cast(JSON.parse(json), r("PropertySet"));
    }

    public static propertySetToJson(value: PropertySet): string {
        return JSON.stringify(uncast(value, r("PropertySet")), null, 2);
    }
}
...
const typeMap: any = {
    "PropertySet": o([
        { json: "artifact", js: "artifact", typ: u(undefined, r("PropertySetArtifact")) },
        { json: "properties", js: "properties", typ: u(undefined, a(r("TaxonomyModelCoreProperty"))) },
    ], "any"),
    "PropertySetArtifact": o([
